!(function (a) {
  function e(e) {
    for (var t, n, r = e[0], o = e[1], i = 0, s = []; i < r.length; i++)
      (n = r[i]), u[n] && s.push(u[n][0]), (u[n] = 0);
    ...
    if (0 !== n)
      if (n) e.push(n[2]);
        ...
        (s.charset = "utf-8"),
          ...
          (s.src = o.p + "js/" + i + ".bundle.b0cf66db2cfba9e91e39.js"),
          (r = function (e) {
    ...
    !(function (e, t) {
            ...
            if (null != (e = arguments[a]))
              for (t in e)
                (r = e[t]),
                  "__proto__" !== t &&
                    s !== r &&
                    (c && r && (E.isPlainObject(r) || (o = Array.isArray(r)))
                      ? ((n = s[t]),
                        (i =
                          o && !Array.isArray(n)
                            ? []
      ...
      var d = (function (n) {
        ...
        function ae(t, e, n, r) {
          ...
          if (
            !r &&
            ((e ? e.ownerDocument || e : m) !== C && T(e), (e = e || C), k)
          ) {
            if (11 !== p && (u = Z.exec(t)))
              if ((o = u[1])) {
                if (9 === p) {
                ...
                ? function (e, t) {
                    ...
                    return (
                      ...
                      (!d.sortDetached && t.compareDocumentPosition(e) === n)
                        ? e === C || (e.ownerDocument === m && v(m, e))
                          ? -1
                          : t === C || (t.ownerDocument === m && v(m, t))
                          ? 1
                          : u
                          ? H(u, e) - H(u, t)
                          : 0
        ...
        (ae.attr = function (e, t) {
          ...
          var n = x.attrHandle[t.toLowerCase()],
            r =
              n && D.call(x.attrHandle, t.toLowerCase()) ? n(e, t, !k) : void 0;
          return void 0 !== r
            ? r
            : d.attributes || !k
            ? e.getAttribute(t)
                        ...
                        for (
                          d =
                            (a =
                              (r =
                                (o =
                                  (i = (s = l)[E] || (s[E] = {}))[s.uniqueID] ||
                                  (i[s.uniqueID] = {}))[h] || [])[0] === S &&
                              r[1]) && r[2],
                            s = a && l.childNodes[a];
                          (s = (++a && s && s[c]) || (d = a = 0) || u.pop());
          ...
          pseudos: {
            not: ce(function (e) {
              ...
              return a[E]
                ...
                : function (e, t, n) {
                    return (
                      (r[0] = e), a(r, null, n, o), (r[0] = null), !o.pop()
                    );
                  };
            }),
            has: ce(function (t) {
          ...
          return (
            ...
            ce(function (e, t, n, r) {
              var o,
                ...
                p = g ? (v || (e ? d : c || y) ? [] : t) : f;
              if ((g && g(f, p, n, r), y))
                for (o = Te(p, u), y(o, [], n, r), i = o.length; i--; )
                  (s = o[i]) && (p[u[i]] = !(f[u[i]] = s));
              if (e) {
                if (v || d) {
                  if (v) {
        ...
        return (
          ...
          (h = ae.tokenize = function (e, t) {
            ...
            for (s = e, a = [], u = x.preFilter; s; ) {
              for (i in ((n && !(r = $.exec(s))) ||
                (r && (s = s.slice(r[0].length) || s), a.push((o = []))),
              (n = !1),
              (r = z.exec(s)) &&
                ((n = r.shift()),
              ...
              (s = j(
                ...
                (r = function (e, t, n, r, o) {
                  ...
                  for (
                    ...
                    if (b && i) {
                      for (
                        s = 0, t || i.ownerDocument === C || (T(i), (n = !k));
                        (a = y[s++]);
          ...
          (g = ae.select = function (e, t, n, r) {
            ...
            if (((n = n || []), 1 === l.length)) {
              if (
                ...
                if (
                  !(t = (x.find.ID(s.matches[0].replace(te, ne), t) || [])[0])
                )
                  return n;
                c && (t = t.parentNode), (e = e.slice(i.shift().value.length));
              }
              for (
                o = V.needsContext.test(e) ? 0 : i.length;
                o-- && ((s = i[o]), !x.relative[(a = s.type)]);
                ...
                if (
                  ...
                  (r = u(
                    ...
                    (ee.test(i[0].type) && ve(t.parentNode)) || t
                  ))
                ) {
                  if ((i.splice(o, 1), !(e = r.length && be(i))))
          ...
          (d.sortStable = E.split("").sort(A).join("") === E),
      ...
      ((E.fn.init = function (e, t, n) {
        ...
        return (
          (o = k.getElementById(r[2])) && ((this[0] = o), (this.length = 1)),
          this
        );
      }).prototype = E.fn),
        (D = E(k));
      ...
      (E.Callbacks = function (r) {
        ...
        E.extend({
              ...
              s = {
                ...
                then: function (t, n, r) {
                        ...
                        e = function () {
                          ...
                          if (!(o < u)) {
                            ...
                            (t =
                              ...
                              m(t)
                                ? a
                                  ? t.call(e, c(u, i, M, a), c(u, i, I, a))
                                  : (u++,
                                    t.call(
                                      e,
                                      c(u, i, M, a),
                                      c(u, i, I, a),
                                      c(u, i, M, i.notifyWith)
                                    ))
                                : (s !== M && ((n = void 0), (r = [e])),
                                  (a || i.resolveWith)(n, r));
                          }
                  ...
                  return E.Deferred(function (e) {
                    i[0][3].add(c(0, e, m(r) ? r : M, e.notifyWith)),
                      i[1][3].add(c(0, e, m(t) ? t : M)),
                      i[2][3].add(c(0, e, m(n) ? n : I));
                  }).promise();
                },
                promise: function (e) {
          ...
          when: function (e) {
            ...
            if (
              n <= 1 &&
              (R(e, i.done(s(t)).resolve, i.reject, !n),
              "pending" === i.state() || m(o[t] && o[t].then))
            )
              return i.then();
      ...
      E.extend({
        ...
        E.fn.extend({
          data: function (n, e) {
            ...
            if (
              this.length &&
              ((o = J.get(i)), 1 === i.nodeType && !Y.get(i, "hasDataAttrs"))
            ) {
              for (t = s.length; t--; )
                s[t] &&
              ...
              ? ("none" === n &&
                ...
                "" === r.style.display &&
                  ...
                  (c[l] =
                    ...
                    (a = o.nodeName),
                    (u = ce[a]) ||
                      ((i = s.body.appendChild(s.createElement(a))),
                      (u = E.css(i, "display")),
                      i.parentNode.removeChild(i),
                      "none" === u && (u = "block"),
                      (ce[a] = u)))))
              : "none" !== n && ((c[l] = "none"), Y.set(r, "display", n)));
      ...
      function xe(e, t, n, r, o) {
        ...
        for (f.textContent = "", d = 0; (i = p[d++]); )
          if (r && -1 < E.inArray(i, r)) o && o.push(i);
            ...
            ((c = oe(i)), (s = ge(f.appendChild(i), "script")), c && ye(s), n)
          )
            for (l = 0; (i = s[l++]); ) de.test(i.type || "") && n.push(i);
        return f;
      }
      (ve = k.createDocumentFragment().appendChild(k.createElement("div"))),
      ...
      function Me(e, t) {
        ...
        if (1 === t.nodeType) {
          if (
            Y.hasData(e) &&
            ((i = Y.access(e)), (s = Y.set(t, i)), (c = i.events))
          )
            for (o in (delete s.handle, (s.events = {}), c))
              for (n = 0, r = c[o].length; n < r; n++)
                E.event.add(t, o, c[o][n]);
          J.hasData(e) &&
            ((a = J.access(e)), (u = E.extend({}, a)), J.set(t, u));
        }
      }
      function Ie(n, r, o, i) {
        r = g.apply([], r);
        var e,
          ...
          d = r[0],
          h = m(d);
        if (h || (1 < f && "string" == typeof d && !v.checkClone && Le.test(d)))
        ...
        if (
          f &&
          ((t = (e = xe(r, n[0].ownerDocument, !1, n, i)).firstChild),
          1 === e.childNodes.length && (e = t),
          t || i)
        ) {
          for (a = (s = E.map(ge(e, "script"), qe)).length; l < f; l++)
            (u = e),
              l !== p &&
          ...
          if (a)
            for (
              c = s[s.length - 1].ownerDocument, E.map(s, He), l = 0;
              l < a;
              l++
            )
              (u = s[l]),
      ...
      function Re(e, t, n) {
        for (var r, o = t ? E.filter(t, e) : e, i = 0; null != (r = o[i]); i++)
          n || 1 !== r.nodeType || E.cleanData(ge(r)),
            r.parentNode &&
              (n && oe(r) && ye(ge(r, "script")), r.parentNode.removeChild(r));
        return e;
      }
      E.extend({
        ...
        clone: function (e, t, n) {
          ...
          if (
            ...
            for (s = ge(l), r = 0, o = (i = ge(e)).length; r < o; r++)
              (a = i[r]),
                (u = s[r]),
                void 0,
                "input" === (c = u.nodeName.toLowerCase()) && fe.test(a.type)
                  ? (u.checked = a.checked)
                  : ("input" !== c && "textarea" !== c) ||
          ...
          if (t)
            if (n)
              for (
                i = i || ge(e), s = s || ge(l), r = 0, o = i.length;
                r < o;
                r++
              )
                Me(i[r], s[r]);
          ...
          return (
            0 < (s = ge(l, "script")).length && ye(s, !f && ge(e, "script")), l
          );
        },
      ...
      function Ze(e, t, n, r, o, i) {
        ...
        for (; s < 4; s += 2)
          "margin" === n && (u += E.css(e, n + ne[s], !0, o)),
            r
              ? ("content" === n && (u -= E.css(e, "padding" + ne[s], !0, o)),
                "margin" !== n &&
                  (u -= E.css(e, "border" + ne[s] + "Width", !0, o)))
              : ((u += E.css(e, "padding" + ne[s], !0, o)),
                "padding" !== n
                  ? (u += E.css(e, "border" + ne[s] + "Width", !0, o))
      ...
      function et(e, t, n) {
        ...
        return (
          ((!v.boxSizingReliable() && o) ||
            ...
            (i = a in e) && (s = e[a])),
          (s = parseFloat(s) || 0) +
            Ze(e, t, n || (o ? "border" : "content"), i, r, s) +
            "px"
        );
      }
      ...
      function pt(i, e, t) {
        ...
        for (
          ...
          if ((n = pt.prefilters[r].call(c, i, l, c.opts)))
            return (
              m(n.stop) &&
        ...
        return (
          E.map(l, ft, c),
          m(c.opts.start) && c.opts.start.call(i, c),
          c
            .progress(c.opts.progress)
            .done(c.opts.done, c.opts.complete)
            .fail(c.opts.fail)
            .always(c.opts.always),
          E.fx.timer(E.extend(u, { elem: i, anim: c, queue: c.opts.queue })),
          c
        );
      }
      (E.Animation = E.extend(pt, {
        ...
        tweener: function (e, t) {
          for (
            var n, r = 0, o = (e = m(e) ? ((t = e), ["*"]) : e.match(H)).length;
            r < o;
            r++
          )
            (n = e[r]),
          ...
          function (e, t, n) {
            ...
            if ((u = !E.isEmptyObject(t)) || !E.isEmptyObject(d))
              for (r in (f &&
                ...
                null == (c = y && y.display) && (c = Y.get(e, "display")),
          ...
          stop: function (o, e, i) {
            ...
            return (
              ...
              this.each(function () {
                ...
                else for (t in r) r[t] && r[t].stop && at.test(t) && s(r[t]);
                for (t = n.length; t--; )
                  n[t].elem !== this ||
                    (null != o && n[t].queue !== o) ||
          ...
          toggleClass: function (o, t) {
            ...
            return "boolean" == typeof t && s
              ...
              : this.each(function () {
                  var e, t, n, r;
                  if (s)
                    for (t = 0, n = E(this), r = bt(o); (e = r[t++]); )
                      n.hasClass(e) ? n.removeClass(e) : n.addClass(e);
                  else
                    (void 0 !== o && "boolean" !== i) ||
                      ((e = mt(this)) && Y.set(this, "__className__", e),
                      this.setAttribute &&
                        this.setAttribute(
                          "class",
                          e || !1 === o
      ...
      E.extend(E.event, {
        trigger: function (e, t, n, r) {
          ...
          if (
            ...
            if (!r && !l.noBubble && !b(n)) {
              for (
                a = l.delegateType || d, wt.test(a + d) || (i = i.parentNode);
                i;
                i = i.parentNode
              )
                p.push(i), (s = i);
            ...
            for (o = 0; (i = p[o++]) && !e.isPropagationStopped(); )
              (f = i),
                ...
                (c =
                  (Y.get(i, "events") || {})[e.type] && Y.get(i, "handle")) &&
                  c.apply(i, t),
                (c = u && i[u]) &&
                  c.apply &&
                  G(i) &&
          ...
          E.each({ focus: "focusin", blur: "focusout" }, function (n, r) {
            ...
            E.event.special[r] = {
              ...
              teardown: function () {
                ...
                t
                  ? Y.access(e, r, t)
                  : (e.removeEventListener(n, o, !0), Y.remove(e, r));
              },
            };
          });
      var Ct = C.location,
      ...
      function Dt(n, e, r, o) {
        ...
        else for (t in e) Dt(n + "[" + t + "]", e[t], r, o);
      }
      ...
      (Bt.href = Ct.href),
        E.extend({
          ...
          ajax: function (e, t) {
            ...
            if (
              (b.promise(T),
              (y.url = ((e || y.url || Ct.href) + "").replace(
                Mt,
                Ct.protocol + "//"
              )),
              (y.type = t.method || t.type || y.method || y.type),
              (y.dataTypes = (y.dataType || "*").toLowerCase().match(H) || [
                "",
              ]),
              null == y.crossDomain)
            ) {
              ...
              try {
                (r.href = y.url),
                  (r.href = r.href),
                  (y.crossDomain =
                    Bt.protocol + "//" + Bt.host != r.protocol + "//" + r.host);
              } catch (e) {
                y.crossDomain = !0;
              }
            }
            if (
              ...
              return T;
            for (o in ((g = E.event && y.global) &&
              0 == E.active++ &&
              E.event.trigger("ajaxStart"),
            (y.type = y.type.toUpperCase()),
            (y.hasContent = !Ht.test(y.type)),
            (f = y.url.replace(Ot, "")),
            y.hasContent
              ? y.data &&
                y.processData &&
            ...
            T.setRequestHeader(
              ...
              y.dataTypes[0] && y.accepts[y.dataTypes[0]]
                ? y.accepts[y.dataTypes[0]] +
                    ("*" !== y.dataTypes[0] ? ", " + _t + "; q=0.01" : "")
                : y.accepts["*"]
            ),
            y.headers))
              T.setRequestHeader(o, y.headers[o]);
            ...
            function c(e, t, n, r) {
              ...
              h ||
                ...
                (T.status = e),
                (T.statusText = (t || c) + ""),
                o ? b.resolveWith(v, [i, c, T]) : b.rejectWith(v, [T, c, s]),
                T.statusCode(w),
                (w = void 0),
                g &&
                  m.trigger(o ? "ajaxSuccess" : "ajaxError", [T, y, o ? i : s]),
                x.fireWith(v, [T, c]),
                g &&
            ...
            return {
              send: function (e, t) {
                ...
                (i = function (e) {
                  return function () {
                    i &&
                      ((i = s = r.onload = r.onerror = r.onabort = r.ontimeout = r.onreadystatechange = null),
                      "abort" === e
                        ? r.abort()
                        : "error" === e
      ...
      E.ajaxSetup({
        ...
        (v.createHTMLDocument =
          (((Xt = k.implementation.createHTMLDocument("").body).innerHTML =
            "<form></form><form></form>"),
            ...
            "static" === c && (e.style.position = "relative"),
              ...
              (o =
                ...
                -1 < (i + u).indexOf("auto")
                  ...
                  : ((s = parseFloat(i) || 0), parseFloat(u) || 0)),
        ...
        E.each(["top", "left"], function (e, n) {
          E.cssHooks[n] = $e(v.pixelPosition, function (e, t) {
            if (t)
              return (t = We(e, n)), _e.test(t) ? E(e).position()[n] + "px" : t;
          });
        }),
      ...
      return (
        (E.noConflict = function (e) {
          return (
            C.$ === E && (C.$ = Jt), e && C.jQuery === E && (C.jQuery = Yt), E
          );
        }),
        e || (C.jQuery = C.$ = E),
        E
                        ...
                        ? (this.timeout = setTimeout(function () {
                            ...
                            if ("^" === t.charAt(0) && /^\^\d+/.test(t)) {
                              ...
                              (n += (t = /\d+/.exec(t)[0]).length),
                                ...
                                (o = o.substring(0, i) + o.substring(i + n)),
                                s.toggleBlinking(!0);
                            }
                            if ("`" === t.charAt(0)) {
                              for (
                                ;
                                "`" !== o.substr(i + a).charAt(0) &&
                                !(i + ++a > o.length);
                    ...
                    value: function (e) {
                      ...
                      if (
                        ...
                        e.showCursor &&
                          ...
                          0 !== n.length &&
                            ((n.innerHTML = r), document.body.appendChild(n));
                      }
                    },
                  },
                ]),
  ...
  function (e, t, n) {
    var r = (function (i) {
          ...
          (c._invoke =
            ...
            function (e, t) {
              ...
              for (a.method = e, a.arg = t; ; ) {
                ...
                "throw" === o.type &&
                  ((u = g), (a.method = "throw"), (a.arg = o.arg));
              }
            })),
          c
        );
      ...
      return (
        (a.prototype = w.constructor = l),
        (l.constructor = a),
        (l[r] = a.displayName = "GeneratorFunction"),
  ...
  function (e, t, n) {
    ...
    h(),
      s()(document).ready(function () {
        // var e, t;
        // (e = ".hero__typing-content"),
        // (t =
        //   "I <b class='pink'>CODE</b> therefore <b class='yellow'>I AM.</b>"),
        // new u.a(e, i()({}, c, { strings: [t] })),
        s()(window).on("scroll", function () {
          40 <= s()(window).scrollTop()
            ? s()(".navbar").addClass("hide-background")
            : s()(".navbar").removeClass("hide-background");
        }),
          s()(window).on("scroll", function () {
          ...
          s()(".scrolling-link").each(function (e, t) {
            s()(t).click(function (e) {
              ...
              var t = s()(e.target).attr("href"),
                n = s()(t);
              s()("html, body").animate({ scrollTop: n.offset().top }, "slow");
            });
          }),
